    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back, Clothify Store Owner!</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Total Sales", val: "₹45,230", icon: DollarSign, color: "text-green-600" },
          { label: "Pending Orders", val: "12", icon: Package, color: "text-orange-600" },
          { label: "Products", val: "84", icon: ShoppingBag, color: "text-blue-600" },
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-primary to-purple-600 p-6 rounded-3xl text-white shadow-xl">
          ...
          <Link href="/dashboard/shopkeeper/products">
