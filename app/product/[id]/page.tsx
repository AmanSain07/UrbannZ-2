...
export default function ProductPage(props: { params: Promise<{ id: string }> }) {
  ...
  // Use provided images or fallback to single image in array for gallery
          ...
          <div className="space-y-4">
            ...
            >
              <img
                ...
                alt={product.name}
                className="w-full h-full object-cover transition-transform duration-700 ease-in-out group-hover:scale-150 origin-center"
              />
