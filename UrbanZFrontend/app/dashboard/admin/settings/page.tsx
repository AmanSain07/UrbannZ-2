...
import { User as UserIcon, Mail, Phone, Save, Lock, Loader2, CheckCircle, Shield, AlertTriangle } from "lucide-react";
      ...
      <div className="grid md:grid-cols-3 gap-8 items-start">
        ...
        <div className="bg-card border border-border/50 rounded-3xl p-6 shadow-sm space-y-6">
          <div className="flex flex-col items-center text-center space-y-4 py-4">
            <div className="size-24 rounded-full bg-gradient-to-tr from-violet-600 to-indigo-500 text-white flex items-center justify-center font-bold text-4xl shadow-xl shadow-indigo-600/10">
              {initials}
            </div>
            <div>
